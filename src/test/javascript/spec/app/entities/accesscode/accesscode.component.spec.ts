...
import { AccesscodeComponent } from 'app/entities/accesscode/accesscode.component';
...
describe('Component Tests', () => {
    describe('Accesscode Management Component', () => {
        let comp: AccesscodeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AccesscodeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.accesscodes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
