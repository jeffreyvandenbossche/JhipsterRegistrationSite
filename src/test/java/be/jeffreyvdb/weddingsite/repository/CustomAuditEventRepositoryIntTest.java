...
import be.jeffreyvdb.weddingsite.config.audit.AuditEventConverter;
import be.jeffreyvdb.weddingsite.domain.PersistentAuditEvent;
...
import static be.jeffreyvdb.weddingsite.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
