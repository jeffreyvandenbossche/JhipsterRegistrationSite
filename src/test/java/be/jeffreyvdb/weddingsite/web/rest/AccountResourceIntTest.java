...
import be.jeffreyvdb.weddingsite.config.Constants;
import be.jeffreyvdb.weddingsite.domain.Authority;
import be.jeffreyvdb.weddingsite.domain.User;
import be.jeffreyvdb.weddingsite.repository.AuthorityRepository;
import be.jeffreyvdb.weddingsite.repository.UserRepository;
import be.jeffreyvdb.weddingsite.security.AuthoritiesConstants;
import be.jeffreyvdb.weddingsite.service.MailService;
import be.jeffreyvdb.weddingsite.service.UserService;
import be.jeffreyvdb.weddingsite.service.dto.PasswordChangeDTO;
import be.jeffreyvdb.weddingsite.service.dto.UserDTO;
import be.jeffreyvdb.weddingsite.web.rest.errors.ExceptionTranslator;
import be.jeffreyvdb.weddingsite.web.rest.vm.KeyAndPasswordVM;
import be.jeffreyvdb.weddingsite.web.rest.vm.ManagedUserVM;
